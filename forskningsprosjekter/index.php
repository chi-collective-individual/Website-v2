        ...
        <div class="indent">
            ...
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    ...
                    -->
                    <a title="Utlysning Simonsen" href="./ProjectSimonsen.pdf" target="_blank" class="two-split mt"><div class="hover-shadow"><h3>Wave scattering from disordered surfaces</h3><p>When an electromagnetic wave interacts with a disordered surface, so-called speckle patterns result. Such patterns have fascinating statistical properties and ... Show more</p></div></a>
                    <a title="Utlysning Dias" href="./Project_Dias.docx.pdf" target="_blank" class="two-split mt"><div class="hover-shadow"><h3>Enzyme conjugation for enhanced adsorption</h3><p>Biocatalysis has emerged as an important technology in green and sustainable synthesis of pharmaceuticals, vitamins, flavor and fragrances. However ... Show more</p></div></a>
                    <a title="Utlysning QuSpin" href="./Utlysning_QuSpin.pdf" target="_blank" class="two-split "><div class="hover-shadow"><h3>Utlysning SFF QuSpin</h3><p>Hvordan ivaretas kvinneandelen i fysikkutdannelser? Det kan virke som at det er et stort frafall kvinner innenfor høyere nivå på fysikk, spesielt innenfor teoretisk fysikk. Vi ønsker å hente inn mer kunnskap om dette... Les mer</p></div></a>
                    <a title="Utlysning Skolelaboratoriet" href="./realfagsloyper_skolelab.pdf" target="_blank" class="two-split mt"><div class="hover-shadow"><h3>Utlysning skolelaboratoriet</h3><p>Prosjektet innebærer å evaluere og foreslå endringer i Fysikkløypa (6. trinn) og Energiløypa (VG1). Evalueringen skal bygge på undersøkelse gjennom observasjon og samtaler med elever som deltar i disse Realfagløypene, deres lærere og studentassistenter som veileder elevene... Les mer</p></div></a>
