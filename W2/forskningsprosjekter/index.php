        ...
        <div class="indent">
            ...
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    ...
                    -->
                    <a title="Utlysning Skolelaboratoriet" href="./realfagsloyper_skolelab.pdf" target="_blank" class="two-split"><div class="hover-shadow"><h3>Utlysning skolelaboratoriet</h3><p>Prosjektet innebærer å evaluere og foreslå endringer i Fysikkløypa (6. trinn) og Energiløypa (VG1). Evalueringen skal bygge på undersøkelse gjennom observasjon og samtaler med elever som deltar i disse Realfagløypene, deres lærere og studentassistenter som veileder elevene. I oppdraget må man derfor følge elevgrupper rundt på stasjonene i løypene... Les mer</p></div></a>
                    <a title="Utlysning Skolelaboratoriet" href="./Elektrisitet_skolelab.pdf" target="_blank" class="two-split"><div class="hover-shadow"><h3>Utlysning skolelaboratoriet</h3><p>Vi ønsker nå hjelp med å systematisere og analysere datamaterialet for de ulike gruppene. Det er utviklet et enkelt verktøy som kan være til hjelp i dette arbeidet. Vi ønsker at studien skal ende opp med en hensiktsmessig oversikt over resultatene, samt hvilke trender en kan se blant studenter som nylig har startet studiet og som har hatt undervisning ett år... Les mer</p></div></a>
                    ...
                    <a href="./electron_propagation.pdf" target="_blank" title="Researh assistant" class="two-split mt"><div class="hover-shadow"><h3>Electron propagation in extragalactic space </h3><p>Electrons propagating from extragalactic sources to Earth may loose energy, as they excite waves in the plasma filling the intergalactic space. In this project, the student will survey rates for this loss mechanism suggested in the literature and implement them in a numerical routine... Read more.</p></div></a>
