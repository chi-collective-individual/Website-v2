        ...
        <div class="indent">
            ...
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    ...
                    -->
                    <a href="./Prosjekt_Laboratorie_Journal.pdf" target="_blank" title="Oppdatering og oversetting av hefte" class="two-split"><div class="hover-shadow"><h3>Uppdatering och översättning av häfte</h3><p>I och med omläggning av laborationer och examination av laborativt arbete kommer det att läggas större vikt på journalföring. Bland annat kommer det att införas en «open-bok» examination där innehållet i laboratorie journalen... Les mer.</p></div></a>
