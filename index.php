           ...
           <!-- <div class="bg-smaragd"><div class="flex-container"><p class="split-narrow">Vil du vite mer om pågående studentprosjekter? Møt opp på fredagskollokvie 1. nov for å høre andre fysikkstudenter fortelle om sine prosjekter...Les mer.<br><a href="https://www.ntnu.edu/physics/colloquia" target="_blank" class="white-arrow">&rarr;</a></p> </div> </div> -->
            ...
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    <a href="forskningsprosjekter/index.php" title="Forskningsprosjekter" class="two-split"><div class="hover-shadow"><h3>Forskningsprosjekter</h3><p>Hvis du ønsker å prøve deg som forsker er dette perfekt for deg! Du får muligheten til å arbeide med ditt eget prosjekt. Prosjektene varierer mye, fra numerisk analyse til å reprodusere eksperimentelle forsøk. Les mer.</p></div></a>
                    ...
                    <a href="studentprosjekter/index.php" title="Studentprosjekter" class="two-split"><div class="hover-shadow"><h3>Studentprosjekter</h3><p>Brenner du inne med en idé du ønsker å realisere? Vil du samarbeide med andre studenter og anvende dine praktiske og analytiske ferdigheter? Her finner du tidligere prosjekter, nåværende prosjekter og eksterne prosjekter. Les mer.</p></div></a>
                </div>
            </div>
            ...
            <!--Information about Prosjekt Scrödinger in English-->
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    ...
                    <div class="two-split">
                        <p>Project Schrödinger (PS) is all about experiencing new things. We believe that collaborating with some of the leading scientists in Norway will increase your interest in physics and develop your skills. By being more involved in real life research early in your studies you will increase your knowledge from the beginning. Getting to know more people make it easier to discuss problems or difficulties you might have with certain topics.</p><br>
                        <p>PS is an initiative made by the Department of Physics in 2019 to make students and staff work closer together. The incentive with the project is to make students more involved in the life of the department, learn how the professors work and eventually become even better students.</p><br>
            ...
            <div class="bg-smaragd">
                ...
                <div class="flex-container footer">
                    <p class="footer-paragraph">For mer informasjon om prosjektutlysninger, henvend deg til kontaktpersonen angitt i utlysningen. <br>Dersom du har andre kommentarer eller spørsmål, vennligst kontakt en av studentassistentene under <a href="./kontakt/index.php">kontakt</a>.</p>
                </div>
            </div>
        </div>
    </body>
