        ...
        <div class="indent">
            ...
            <div class="bg-blue">
                ...
                <div class="flex-container">
                    ...
                    -->
                    <a href="./Project_Jaakko.docx.pdf   " target="_blank" title="Improving Classical Mechanics" class="two-split"><div class="hover-shadow"><h3>Improving course content in Classical Mechanics (TFY4345)</h3><p>Help in improving the course content of TFY4345 (exercises, computational project, supplemental material). ​ The project considers two parts ... Show more.</p></div></a>
                    <a href="./fy3403.pdf" target="_blank" title="Numerical exercises in particle physics" class="two-split mt"><div class="hover-shadow"><h3>Developing numerical exercises for Particle Physics </h3><p>Exercises in particle physics contain often tedious calculations of traces over gamma matrices or rather complicated phase space integrals. Aim of this project is to develop exercises... Show more.</p></div></a>
                    <a href="./FY2450EmneutviklerAstro.pdf" target="_blank" title="Oppdatering av kompendium i astrofysikk" class="two-split"><div class="hover-shadow"><h3>Oppdatering av kompendium i astrofysikk</h3><p>Eg held på skrive eit kompendium i FY2450 astrofysikk. For å kvalitetssikre dette arbeidet, treng eg ein student som kan lese og gje tilbakemelding. I tillegg skal studenten teikne figurar som illustrasjonar... Les meir.</p></div></a>
            ...
            <div class="bg-blue">
                ...
                <!--Mal for å legge ut ferdig prosjekt med prosjektbeskrivelse og rapport-->    
                   ...
                   <div class="two-split"> 
                        ...
                        <a href="./journal.pdf" title="Oversetting og oppdatering av hefte" target="_blank"><div class="hover-shadow">Se prosjektrapport.</div></a>
                   </div>
                   <div class="two-split"> 
